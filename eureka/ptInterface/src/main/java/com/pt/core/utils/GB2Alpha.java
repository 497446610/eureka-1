...
public class GB2Alpha {
	 ...
	 * @return 返回转换后的拼
	 */
	public static String getHeadSpell(String cnStr) {
		if (null == cnStr || "".equals(cnStr.trim())) {
			return cnStr;
		}
		...
		if (ascii == 0) { // 取ascii时出错
			...
			if (spell == null) {
				...
				return spell.substring(0, 1).toLowerCase();
			}
		}
	}
	...
	public static void main(String[] args) {
		String str = "Hahaha";
		// 转换成拼音
		System.out.println(GB2Alpha.getHeadSpell(str));
